namespace Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ProcductID = c.Int(nullable: false),
                        Quantity = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.OrderID, t.ProcductID })
                .ForeignKey("dbo.Orders", t => t.OrderID, cascadeDelete: true)
                .ForeignKey("dbo.Products", t => t.ProcductID, cascadeDelete: true)
                .Index(t => t.OrderID)
                .Index(t => t.ProcductID);
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false),
                        Descripttion = c.String(maxLength: 256),
                        Image = c.String(maxLength: 256),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderDetails", "ProcductID", "dbo.Products");
            ...
            DropIndex("dbo.OrderDetails", new[] { "ProcductID" });
